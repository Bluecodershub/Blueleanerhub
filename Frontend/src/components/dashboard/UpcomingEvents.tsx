      ...
      <div className="space-y-3">
        {events.map((event, idx) => (
          <motion.div
            ...
            className="flex gap-3 rounded-lg bg-gray-50 p-3 transition-colors hover:bg-gray-100 dark:bg-popover/50 dark:hover:bg-gray-700"
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-gray-500 dark:text-muted-foreground">{event.date}</p>
            </div>
            {event.status === 'today' && (
