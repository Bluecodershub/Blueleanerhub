  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-6 text-center text-foreground">
      <div className="max-w-3xl space-y-8">
        ...
        <div className="pt-8">
          <Button className="group h-14 rounded-2xl bg-primary px-10 text-lg font-black text-primary-foreground shadow-xl shadow-primary/15 transition-all hover:bg-primary/90 active:scale-95">
